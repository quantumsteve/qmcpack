...
public:
  ...
  UPtrVector<RandomBase<QMCTraits::RealType>>& get_rng_ptr_list() { return rng_ptr_list_; }
  RandomBase<QMCTraits::RealType>& get_rng_save() { return *rng_save_ptr_; }
...
private:
  ...
  UPtrVector<RandomBase<QMCTraits::RealType>> rng_ptr_list_;
  ...
  std::unique_ptr<RandomBase<QMCTraits::RealType>> rng_save_ptr_;
