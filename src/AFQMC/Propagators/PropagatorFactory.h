...
public:
  ...
  Propagator& getPropagator(TaskGroup_& TG,
                            const std::string& ID,
                            Wavefunction& wfn,
...
protected:
  ...
  Propagator buildPropagator(TaskGroup_& TG, xmlNodePtr cur, Wavefunction& wfn, RandomBase<QMCTraits::RealType>& rng)
  {
  ...
  Propagator buildAFQMCPropagator(TaskGroup_& TG,
                                  xmlNodePtr cur,
                                  Wavefunction& wfn,
