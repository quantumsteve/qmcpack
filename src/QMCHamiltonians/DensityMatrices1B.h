...
//#define DMCHECK
  ...
  RandomBase<QMCTraits::RealType>* uniform_random;
  ...
  void setRandomGenerator(RandomBase<QMCTraits::RealType>* rng) override;
  ...
  void generate_uniform_grid(RandomBase<QMCTraits::RealType>& rng);
  void generate_uniform_samples(RandomBase<QMCTraits::RealType>& rng);
  void generate_density_samples(bool save, int steps, RandomBase<QMCTraits::RealType>& rng);
