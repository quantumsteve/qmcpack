...
void DensityMatrices1B::setRandomGenerator(RandomBase<QMCTraits::RealType>* rng) { uniform_random = rng; }
...
inline void DensityMatrices1B::generate_uniform_grid(RandomBase<QMCTraits::RealType>& rng)
{
  PosType rp;
  PosType ushift = 0.0;
...
inline void DensityMatrices1B::generate_uniform_samples(RandomBase<QMCTraits::RealType>& rng)
{
  PosType rp;
  for (int s = 0; s < samples; ++s)
  {
...
inline void DensityMatrices1B::generate_density_samples(bool save, int steps, RandomBase<QMCTraits::RealType>& rng)
{
